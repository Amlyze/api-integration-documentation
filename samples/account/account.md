...
* [account_active.json](samples%2Faccount%2Faccount_active.json)
* [account_suspended.json](samples/account/account_suspended.json)
* [account_closed.json](samples%2Faccount%2Faccount_closed.json)
