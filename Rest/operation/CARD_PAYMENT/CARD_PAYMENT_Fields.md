...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td > <b> true </td>
            <td > OP_PK </td>
            <td> Code of risk management category of object. Risk management category code from classifier can be checked <a href="Amlyze/api-integration-documentation/blob/main/Rest/README.md#classifiers">here</a></td>
        </tr>
        <tr>
            ...
            </br>  direction = <b>OUTGOING</b> your customer = <b>DEBTOR</b> </td>
        </tr>
        <tr>
            ...
            <td ><b> true</td>
            <td > CARD_PURCHASE </td>
            <td> CardOperationSubType code from classifier can be checked <a href="Amlyze/api-integration-documentation/blob/main/Rest/README.md#classifiers">here</a></td>
        </tr>
        <tr>
            ...
            <td> Defines which lists to check during screening process<br/> ScreeningList code from classifier can be checked <a href="Amlyze/api-integration-documentation/blob/main/Rest/README.md#classifiers">here</a></td>
        </tr>
        <tr>
            <td ><b> amount </td>
            <td > BigDecimal </td>
        ...
        <tr>
            ...
            <td > <b> true</td>
            <td > EUR </td>
            <td> Currency code from classifier.</br> Currency code from classifier can be checked <a href="Amlyze/api-integration-documentation/blob/main/Rest/README.md#classifiers">here</a></td> 
        </tr>
        <tr>
            <td ><b> description </td>
            <td > String </td>
