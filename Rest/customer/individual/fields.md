...
1. [Create a customer while running an evaluation.](./samples/evaluateMinPayload.json)
1. [Update a customer while running an evaluation.](./samples/evaluateOverwrite.json)
1. [Create a customer while running an evaluation and screening.](./samples/evaluateWithScreening.json)
1. [Create a customer via import.](./samples/importMinPayload.json)
1. [Update a customer via import.](./samples/importOverwriteClosing.json)
1. [Create a customer via import while running screening.](./samples/importWithScreening.json)
1. [Create a customer with complete data.](./samples/fullPayloadExample.json)
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>true</td>
			<td>IMPORT</td>
			<td><div>🚨<b>Alert:</b> Field omitted in batch request and by default is <b>IMPORT</b>.</div><br/> The value <b>EVALUATE</b> is used for initiating a customer risk assessment.<br/> The value <b>IMPORT</b> is used for customer import or customer data updates where initiation of new risk assessment is not needed. This typically applies to customer migration or updating customer data that do not affect customer risk level and automatic customer reassessment is not needed.</td>
		</tr>
		<tr>
			<td><b>riskLevel</b></td>
		...
		<tr>
			...
			<td><div>🚨<b>Alert:</b> Field omitted in batch request.</div><br/>Defines which screening processes to initiate</td>
		</tr>
		<tr>
