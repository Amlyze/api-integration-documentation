...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> CardOperationSubType code from classifier can be checked <a href="https://github.com/Amlyze/api-integration-documentation/Soap/README.md#Classifiers">here</a></td>
        </tr>
        <tr>
            <td ><b> Amount </td>
            <td > BigDecimal </td>
